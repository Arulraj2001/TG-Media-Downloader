...
class DownloadsView(QWidget):
    ...
    def setup_ui(self):
        ...
        self.content_layout.setContentsMargins(22, 22, 22, 38)
        self.content_layout.setSpacing(16)
        self.content_layout.setAlignment(Qt.AlignTop)

        overview = QFrame()
        overview.setObjectName("QueueHero")
        ...
        eyebrow = QLabel("TRANSFER CONTROL")
        eyebrow.setObjectName("Eyebrow")
        title = QLabel("Every file, visible while it moves.")
        title.setObjectName("QueueHeroTitle")
        title.setWordWrap(True)
        copy = QLabel(
            "Pause the full queue, change individual file selections, "
            "or open finished folders without leaving this page."
        )
        copy.setObjectName("DescriptionText")
        copy.setWordWrap(True)
        overview_text.addWidget(eyebrow)
        overview_text.addWidget(title)
        overview_text.addWidget(copy)
        overview_layout.addLayout(overview_text, stretch=1)
        ...
        active_section_layout.setContentsMargins(20, 18, 20, 20)
        active_section_layout.setSpacing(12)

        active_header = QHBoxLayout()
        active_index = QLabel("LIVE")
        active_index.setObjectName("LiveMark")
        self.lbl_active = QLabel("Active downloads")
        self.lbl_active.setObjectName("SectionHeader")
        self.lbl_active.setSizePolicy(QSizePolicy.Ignored, QSizePolicy.Preferred)
        active_header.addWidget(active_index)
        ...
        active_empty_layout.setContentsMargins(18, 18, 18, 18)
        ...
        history_section_layout.setContentsMargins(20, 18, 20, 20)
        history_section_layout.setSpacing(12)

        completed_header = QHBoxLayout()
        history_index = QLabel("LOG")
        history_index.setObjectName("HistoryMark")
        ...
        completed_header.addWidget(history_index)

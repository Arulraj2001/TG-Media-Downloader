...
class UpdateChecker(QThread):
    ...
    def __init__(self, current_version, parent=None):
        ...
        self.repo_url = "https://api.github.com/repos/Arulraj2001/TG-Downloader-/releases/latest"

    def run(self):
        try:
            # Add a user-agent to avoid 403 from GitHub
            req = urllib.request.Request(self.repo_url, headers={'User-Agent': 'TG-Media-Downloader-Update-Checker'})
